...
<head>
	<meta name="facebook-domain-verification" content="xjv6fztc4046bz2mvypcscqg3h8dd3" />
...
<div id="page" class="site">
	...
	<?php endif; ?>
		...
		<?php }
			if(is_front_page()):
		?>
			<div class="slider-custom-content text-center">
				<div class="brand-slogan">Reinventing Luxury</div>
				<button type="button" class="hero-button scroll-down" type="button">Order Now</button>
			</div>
		<?php
			endif;
		?>
